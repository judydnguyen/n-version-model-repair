...
python benchmark.py \
    --agent_0_path saved_ckpts/cartpole_reinforce_weights_attacked_seed_12_repaired_mode_unlearn.pt \
    --agent_1_path saved_ckpts/cartpole_reinforce_weights_attacked_seed_12.pt
